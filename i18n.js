...
(function () {
    ...
    var DICT = {
        pt: {
            ...
            'hero.desc': 'Projetamos plataformas robustas, agentes baseados em IA e infraestrutura em nuvem escalável para acelerar sua entrega digital.',
            ...
            'services.desc': 'Combinamos profunda expertise em engenharia de plataformas com fluxos de trabalho de IA agêntica para entregar resultados de ponta a ponta.',
            'service1.title': 'Plataforma & Infraestrutura',
            'service1.desc': 'Arquitetamos infraestrutura em nuvem escalável e confiável, além de pipelines de CI/CD robustos.',
            'service1.item1': 'Arquitetura Cloud (AWS)',
            'service1.item2': 'Confiabilidade & Observabilidade',
            'service1.item3': 'Sistemas Orientados a Eventos',
            'service1.item4': 'Kubernetes & Docker',
            'service2.title': 'IA &amp; Sistemas Agênticos',
            'service2.desc': 'Construímos agentes de IA autônomos, gateways LLM e fluxos de trabalho inteligentes para equipes de engenharia modernas.',
            'service2.item1': 'Workflows Agênticos (mARC)',
            'service2.item2': 'Gateways LLM',
            'service2.item3': 'Pipelines RAG',
            'service2.item4': 'Engenharia de Prompt',
